      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-lg text-foreground">MyDrHank</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:support@mydrhank.com" className="hover:text-primary transition-colors">
                  support@mydrhank.com
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                <Phone size={16} className="mt-0.5 flex-shrink-0" />
                <a href="tel:1-800-DRHANK" className="hover:text-primary transition-colors">
                  1-800-DRHANK
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>&copy; {currentYear} MyDrHank. All rights reserved.</p>
          <p className="text-xs">
